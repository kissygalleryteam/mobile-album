...
gallery/mobile-album/1.0/core/pc-mouse
gallery/mobile-album/1.0/core/gesture
gallery/mobile-album/1.0/wakeup-popup/index
gallery/mobile-album/1.0/index
...
KISSY.add('gallery/mobile-album/1.0/core/pc-mouse',function(S, Node, Base){
    var $ = Node.all;
    ...
    var o = {
        ...
        ,handleMousedown: function(e){
            ...
            self.ddMouseMask = $('<div style="z-index: 999999;position: fixed;left:0;top:0;width: 100%;height: 100%;cursor: move;"></div>');
...
KISSY.add('gallery/mobile-album/1.0/core/gesture',function(S, Node, Base, PcMouse){
    var $ = Node.all;
...
KISSY.add('gallery/mobile-album/1.0/wakeup-popup/index',function(S, Node, Base){
    var $ = Node.all;
...
KISSY.add('gallery/mobile-album/1.0/index',function(S, Base, Gesture, WakeupPopup){
    var $ = S.all;
